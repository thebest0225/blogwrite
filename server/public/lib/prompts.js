...
// 독창적 관점·전문 분석 — 애드센스 승인의 핵심(검색되는 정보 나열만으론 탈락)
const ORIGINALITY = `
[독창적 관점·전문 분석 — 애드센스 승인 핵심 / 누구나 검색되는 정보 나열만으론 반려된다]
- 검색하면 다 나오는 사실 요약으로 끝내지 마라. 그 위에 '이 글에서만 읽을 수 있는 해석·분석·판단'을 반드시 얹어라.
- 본문에 '독창적 분석' 성격의 섹션을 최소 1~2개 넣어라(소제목에 왜/진짜/짚어보기/관점/뜯어보기 등). 주제 성격에 맞는 각도를 스스로 골라 깊게 파라:
  · 연예·드라마·예능·OTT: 인물·관계의 심리와 다이내믹, 인기의 사회적 맥락, 연출·서사 해석, 시청자 심리 — 단순 줄거리·출연진 나열 금지.
  · 정부지원·혜택·복지: 남들이 놓치는 함정·조건 해석, 누구에게 유리/불리한지 비교 판단, 신청 시 시행착오·전략, 제도가 생긴 맥락.
  · 경제·재테크·생활경제: 숫자 뒤의 의미·전망·리스크, 상황별 트레이드오프, '나라면 이렇게' 판단 근거.
  · 반려동물: 행동·심리 해석, 상황별 판단 기준, 흔한 오해 바로잡기, 경험 기반 케이스.
  · 스마트폰·앱·프로그램: 실사용 관점의 장단 비교, 대안과의 우열, 언제 쓰지 말아야 하는지, 숨은 리스크.
  · 이슈·시사: 사건의 맥락·배경·파장 해석, 서로 다른 관점 정리, 앞으로의 전개 전망.
- 전문가 톤: 근거를 들어 '왜 그런지'를 설명하고, 통념과 다른 지점·예외·주의점을 짚어라. 애매한 일반론·백과사전식 요약 금지.
- 글의 무게중심은 '텍스트(분석·설명)'에 둔다. 표·리스트는 보조일 뿐, 핵심 통찰은 문단으로 풀어라.`;
...
${SEO_TREND}
${HUMAN_VOICE}
[말투·이모지] 친근한 구어체로, 이모지를 자연스럽게 적절히 섞어 사람 냄새를 낸다(문단마다 억지로 넣지는 말고, 과하지 않게).
...
- ★★독창적 분석 소재(애드센스 승인 핵심): 검색하면 다 나오는 사실 외에, 뒤 목적지글이 '고유한 관점·전문 분석'을 쓸 수 있는 재료를 반드시 함께 모아 별도로 정리해라. 주제 성격에 맞는 각도로:
  · 연예·드라마·예능·OTT: 인물·관계의 심리와 다이내믹, 인기의 사회적 맥락, 연출·서사 해석 포인트, 시청자 반응·논쟁거리
  · 정부지원·혜택·복지: 남들이 놓치는 함정·조건 해석, 누구에게 유리/불리한지, 신청 시 시행착오·전략, 제도가 생긴 맥락
  · 경제·재테크·생활경제: 숫자 뒤의 의미·전망·리스크, 상황별 트레이드오프, 서로 상반된 견해
  · 반려동물: 행동·심리 해석, 상황별 판단 기준, 흔한 오해 바로잡기, 경험 기반 케이스
  · 스마트폰·앱·프로그램: 대안과의 우열 비교, 언제 쓰지 말아야 하는지, 숨은 리스크·불편
  · 이슈·시사: 배경·맥락·파장, 서로 다른 관점, 앞으로의 전개 전망
  각 소재에 '왜 그런가 / 무엇을 주의 / 통념과 다른 지점 / 예외 / 전문가라면 어떻게 볼지'를 근거와 함께 담아라(단, 확인 안 된 사실은 지어내지 말고 관점·해석·질문 위주로).
